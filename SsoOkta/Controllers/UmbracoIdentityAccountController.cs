    ...
    public class UmbracoIdentityAccountController : SurfaceController
    {
        ...
        public ActionResult ExternalLogin(string provider, string returnUrl = null)
        {
            ...
            return new ChallengeResult(provider,
                ToAbsoluteUrl(Url.SurfaceAction<UmbracoIdentityAccountController>("ExternalLoginCallback", new { ReturnUrl = returnUrl })));
        }
        ...
        public ActionResult LinkLogin(string provider, string returnUrl = null)
        {
            ...
            return new ChallengeResult(provider,
                ToAbsoluteUrl(Url.SurfaceAction<UmbracoIdentityAccountController>("LinkLoginCallback", new { ReturnUrl = returnUrl })),
